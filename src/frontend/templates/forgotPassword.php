...
<?php
      ...
      //format message
      $greetingText = "Enter this code where prompted to reset your password:\n";      
    ...
    <!--Veridication-->
    <div class="container">
        <h2>Account Ownership Verification</h2>
        <h6> Please enter the verification code that was sent to your email.</h6>
